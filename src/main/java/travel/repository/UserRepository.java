...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT u FROM User u WHERE (:fromDate IS NULL OR u.createdDate >:fromDate)" +
            ...
            "AND (:fullName IS NULL OR u.fullName like :fullName) OR u.userName like :userName")
    List<User> findAllByProperties(@Param("fromDate") Date fromDate, @Param("toDate") Date toDate, @Param("fullName") String fullName,@Param("userName") String userName);
